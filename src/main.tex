...
\cvsection{Bachelor Thesis Advisor} 
    ...
    \cvachievement{\faBook}{ {\bfseries Evaluation and Implementation of a Digitally Sovereign Solution to Increase Usage Transparency of Web-Based Software Products} \hfill { \color{accent} \faCalendar}  \hspace{0.5em}{2024}\smallskip}
    ...
    \cvachievement{\faBook}{ {\bfseries TBD} \hfill { \color{accent} \faCalendar}  \hspace{0.5em}{2021}\smallskip}
    {Duale Hochschule Baden-Württemberg Karlsruhe}\par
    \medskip
